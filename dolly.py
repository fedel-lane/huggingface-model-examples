#!/usr/bin/env python
# Code to test a Databricks Dolly model, one of:
...
# ----------------------------------------------------------------------
def get_args():
    parser = argparse.ArgumentParser( description='Dolly-based chatbot')
    parser.add_argument('--large', dest='large_model', action='store_true',
                    help='Use large (12b) model available locally')
    parser.add_argument('--small', dest='small_model', action='store_true',
                    help='Use small model (3b) available locally')
