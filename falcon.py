#!/usr/bin/env python
# Test code to get up-and-running with a downloaded Falcon model, one of:
#   https://huggingface.co/tiiuae/falcon-7b-instruct
#   https://huggingface.co/tiiuae/falcon-7b
#   https://huggingface.co/tiiuae/falcon-40b-instruct
#   https://huggingface.co/tiiuae/falcon-40b
# Note: Langchain uses huggingface-hub package so model will be loaded from
#    ~/.cache/huggingface/hub/models--tiiuae--falcon-7b-instruct
# Example:
# bash$ python falcon.py
# > Using Q&A prompt with cue "Let's think step by step." Model: tiiuae/falcon-7b-instruct
# > Ask a question:
# Who was Babe Ruth?
# > Babe Ruth was a legendary American baseball player. He was born in 1914 in Brooklyn, New York. He played for the New York Yankees and the New York Giants. His most famous baseball achievement was hitting five home runs in one game. (See Babe Ruth's #5.)
